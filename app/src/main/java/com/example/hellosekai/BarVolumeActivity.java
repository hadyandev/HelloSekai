...
public class BarVolumeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //    save result state for landscape
    @Override
...
//        set result to view for landscape
